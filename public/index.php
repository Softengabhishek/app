...
<main class="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative">
        ...
        <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 280.34 335.07">
            <defs>
                <linearGradient id="linear-gradient" x1="111.49" y1="261.12" x2="145.91" y2="370.59" gradientUnits="userSpaceOnUse">
                    <stop offset="0" stop-color="#2a2839" />
                    <stop offset="1" stop-color="#38435d" />
                </linearGradient>
                <linearGradient id="linear-gradient-2" x1="89.14" y1="228.36" x2="83.5" y2="359.38" xlink:href="#linear-gradient" />
                <linearGradient id="linear-gradient-3" x1="126.34" y1="149.56" x2="155.41" y2="149.56" gradientUnits="userSpaceOnUse">
                    <stop offset="0" stop-color="#746aa6" />
                    <stop offset="0.31" stop-color="#5d5298" />
                    <stop offset="0.75" stop-color="#423687" />
                    <stop offset="1" stop-color="#382b81" />
                </linearGradient>
                <linearGradient id="linear-gradient-4" x1="164.01" y1="151.48" x2="147.49" y2="173.66" xlink:href="#linear-gradient-3" />
                ...
                <linearGradient id="linear-gradient-6" x1="127.49" y1="111.21" x2="137.67" y2="159.59" xlink:href="#linear-gradient-3" />
                <linearGradient id="linear-gradient-7" x1="92.58" y1="96.08" x2="92.58" y2="232.64" xlink:href="#linear-gradient-3" />
                <linearGradient id="linear-gradient-8" x1="110.75" y1="212.47" x2="110.75" y2="115.93" xlink:href="#linear-gradient" />
                <linearGradient id="linear-gradient-9" x1="1046.73" y1="383.6" x2="1112" y2="382.91" gradientTransform="matrix(-0.72, -0.23, -0.4, 0.83, 1082.07, 67.22)" gradientUnits="userSpaceOnUse">
                    ...
                    <stop offset="0.27" stop-color="#e5ecf6" />
                    <stop offset="1" stop-color="#d1ddee" />
                </linearGradient>
                <linearGradient id="linear-gradient-10" x1="102.62" y1="116.25" x2="102.62" y2="105.35" xlink:href="#linear-gradient" />
                <linearGradient id="linear-gradient-11" x1="91" y1="95.76" x2="91" y2="112.53" xlink:href="#linear-gradient-3" />
                <linearGradient id="linear-gradient-12" x1="110.58" y1="95.76" x2="110.58" y2="112.53" xlink:href="#linear-gradient-3" />
                <linearGradient id="linear-gradient-13" x1="76.12" y1="131.17" x2="62.87" y2="198.72" xlink:href="#linear-gradient-3" />
            </defs>
            <title>men</title>
            <g style="isolation:isolate">
                <g id="Capa_1" data-name="Capa 1">
                    ...
                    <path d="M82.48,92.92c-1.25,3.55-13,7.67-13,7.67s35.57,40.73,49.3,40.47-6-38.4-6-38.4-4-2-5.25-5.88,1.37-20.54,1.37-20.54L94.39,67.37S83.73,89.37,82.48,92.92Z" style="mix-blend-mode:multiply;fill:url(#linear-gradient-5)" />
                    ...
                    <line x1="194.99" y1="160.1" x2="194.99" y2="172.78" style="fill:none;stroke:#eaf0f2;stroke-miterlimit:10;stroke-width:0.30236199999999996px" />
    ...
    <div class="sm:w-5/12 xl:w-4/12 flex flex-col items-start sm:items-end sm:text-right ml-auto mt-8 sm:mt-0 relative z-10 xl:pt-20 mb-16 sm:mb-0">
        <h1 class="text-4xl lg:text-5xl text-blue-900 leading-none mb-4 font-black">Business Landing Page</h1>
        <p class="lg:text-lg mb-4 sm:mb-12 text-blue-900">Lorem ipsum dolor sit amet, consectetur adipiscing adipiselit. Pellentesque suscipit tellus vitae purus dignissim, nec tincidunt neque condimentum. Nam nec ligula pretium mi interdum hendrerit in sit.</p>
        <a href="#" class="font-semibold text-lg bg-purple-600 hover:bg-blue-400 text-white py-3 px-12 rounded-full">Learn more</a>
    </div>
    <svg class="w-full absolute bottom-0 left-0" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 497.5 141.26">
        <title>skyline</title>
